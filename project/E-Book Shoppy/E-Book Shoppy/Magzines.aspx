<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Magzines.aspx.cs" Inherits="E_Book_Shoppy.Magzines" %>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-3 bread"><span class="glyphicon glyphicon-book"></span>                Magzines</h1>
                </div>
            </div>
        </div>
    </div>
