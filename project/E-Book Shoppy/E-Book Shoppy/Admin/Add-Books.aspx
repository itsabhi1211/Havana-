<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Add-Books.aspx.cs" Inherits="E_Book_Shoppy.Admin.Add_Books" %>
                    ...
                    <div class="col-lg-6">
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
                                <tbody>
                                    <tr>
                                        <th><span class="fa fa-book fa-2x"></span></th>
                                        <td>
                                            <asp:TextBox ID="txtbookname" runat="server" CssClass="form-control" Placeholder="Book Name..."></asp:TextBox></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th><span class="fa fa-money fa-2x"></span></th>
                                        <td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card-header">
                            <h5 class="text-primary text-uppercase"><span class="fa fa-book fa-2x">           Books Details</span></h5>
                        </div>
                            ...
                            <asp:GridView ID="grdshwdetails" runat="server" CssClass="table table-responsive table-bordered" AutoGenerateColumns="false" OnRowDeleting="grdshwdetails_RowDeleting" AllowPaging="true" PageSize="5" OnPageIndexChanging="grdshwdetails_PageIndexChanging" EmptyDataText="No Record Available As Of Now" EmptyDataRowStyle-CssClass="text-danger">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Image" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center text-dark">
                                        <ItemTemplate>
                                            <asp:Image Id="img1" ImageUrl='<%# Eval("Image") %>' runat="server"  Height="100px" Width="100px"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
