<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Add-Magzines.aspx.cs" Inherits="E_Book_Shoppy.Admin.Add_Magzines" %>
                            ...
                            <table class="table table-borderless table-striped table-earning">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtmagname" runat="server" CssClass="form-control" Placeholder="Magzine Name..."></asp:TextBox></td>
                                    </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card-header">
                            <h5 class="text-primary text-uppercase"><span class="fa fa-newspaper fa-2x">           Magzines Details</span></h5>
                        </div>
