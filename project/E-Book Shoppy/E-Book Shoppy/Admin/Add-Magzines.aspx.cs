...
{
    public partial class Add_Magzines : System.Web.UI.Page
    {
        ...
        void Magdetails()
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("sp_Magzine", con);
                ...
                if (i > 0)
                {
                    lblmsg1.Text = "You Have Successfully Uploaded the Magzine With Its Proper Details....";
                    ClearSection();
                }
                else
                {
        ...
        /// <summary>
        /// code to clear fileds after submission.....
        /// </summary>
        void ClearSection()
        {
            txtprice.Text = "";
        ...
        /// <summary>
        /// code for deleting entries from grid..... 
        /// </summary>
        ...
        protected void grdshwdetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("delete from tblMagzine where ID=" + Convert.ToInt32(ID) + "", con);
                cmd.ExecuteNonQuery();
                con.Close();
                gridBind();
            }
