<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Userlogin.aspx.cs" Inherits="Havana.Userlogin" %>
...
<body>
    ...
    <%--<!-- ##### Header Area End ##### -->
        <%-- login form starts here--%><br /><br /><br /><br /><br /><br />
    <div class="container">
        <div class="row">
             ...
             <div class="col-md-6">
                 <%--<div class="panel">--%>
                     <div class="jumbotron shadow-lg">
                         <h3 class="text-dark text-center"><span class="fa fa-user-circle-o fa-2x"></span>    User Login</h3>
                     </div>
                     ...
                     <div class="card-body">
                         <table class="table table-responsive-lg table-hover shadow-lg">
                          ...
                          <tr> 
                           ...
                           <div class="text-right"><a href="Forgot-Password.aspx" class=" text-danger" >Having trouble in SignIn ?</a></div>
                 </div>
             </div>
