<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forgot-Password.aspx.cs" Inherits="Havana.Forgot_Password" %>
...
<body>
    ...
    <%--<!-- ##### Header Area End ##### -->
        <%-- login form starts here--%><br /><br /><br /><br /><br /><br /><br /><br /><br />
    <div class="container">
        <div class="row">
             ...
             <div class="col-md-6">
                 <%--<div class="panel">--%>
                     <div class="jumbotron shadow-lg">
                         <h3 class="text-dark text-center"><span class="fa fa-lock fa-2x"></span>    Forgot Password</h3>
                     </div>
                     ...
                     <div class="card-body">
                         <table class="table table-responsive-lg table-hover shadow-lg">
                             <tr>
                                 ...
                                 <td>
                                      <input type="text" runat="server" id="txtuserid" placeholder=" Email...." class="form-control" required="required" style="border-radius: 5px 5px" />
                                 </td>
                             </tr>
                          ...
                          <tr> 
                                 ...
                                 <td colspan="2">
                                     <asp:Button ID="btnchangepasword" runat="server" Text="Change Password" cssclass=" btn btn-outline-dark btn-block south-btn " style="border-radius: 5px 5px" OnClick="btnchangepasword_Click"/>
                                 </td>
