<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="Havana.AdminLogin" %>
        ...
        <div class="top-header-area">
            <div class="h-100 d-md-flex justify-content-between align-items-center">
                <div class="email-address">
                    <a href="mailto:havanahomes4u@gmail.com"><b>havanahomes4u@gmail.com</b></a>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="jumbotron shadow-lg">
                    <h3 class="text-dark text-center"><span class="fa fa-user-o fa-2x"></span>    Admin Login</h3>
                </div>
                 <div>
                <asp:Label ID="lblmsg" runat="server" CssClass="alert alert-secondary" Visible="false"></asp:Label>
            </div>
                <div class="card-body">
                    <table class="table table-responsive-lg table-hover shadow-lg">
                        <tr>
                            <th><span class="fa fa fa-user-o fa-2x"></span></th>
                            <td>
                                <input type="text" runat="server" id="txtuserid" placeholder=" UserId...." class="form-control" required="required" style="border-radius: 5px 5px" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="btnlogin" runat="server" Text="Sign In" CssClass=" btn btn-outline-dark btn-block south-btn " style="border-radius: 5px 5px" OnClick="btnlogin_Click" />
                            </td>
