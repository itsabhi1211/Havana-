<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminindex.Master" AutoEventWireup="true" CodeBehind="Feedback-Reply.aspx.cs" Inherits="Havana.Admin.Feedback_Reply" %>
                    ...
                    <div class="card-body shadow-lg" >
                        ...
                        <table class="table table-responsive table-borderless table-hover">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="txtnme" runat="server" class="form-control" style="border-radius: 5px 5px" readonly="readonly"></td>
                               
                            </tr>
                            <tr>
                                 <td ><span class="fa fa-mobile fa-2x text-secondary"></span></td>
                                 <td>
                                      <input type="text" id="txtcontact" runat="server" class="form-control" style="border-radius: 5px 5px" readonly="readonly"/>
                                </td>
                            </tr>
                            <tr>
                                 <td ><span class="fa fa-envelope fa-2x text-secondary"></span></td>
                                 <td>
                                      <input type="text" id="txtemail" runat="server" class="form-control" style="border-radius: 5px 5px" readonly="readonly"/>
                                </td>
                            </tr>
                            <tr>
